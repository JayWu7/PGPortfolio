...
class NNAgent:
    def __init__(self, config, restore_dir=None, device="cpu"):
        ...
        self.__coin_number = config["input"]["coin_number"]  # 11
        ...
        self.__loss = self.__set_loss_function()  # 计算loss的函数
    ...
    def init_train(self, learning_rate, decay_steps, decay_rate, training_method):  # 初始化训练
